...
export const metadata: Metadata = {
  title: "Про Компанію | VOLT PREMIUM",
  description: "Дізнайтеся більше про нашу місію, підхід до електромонтажу преміум-класу та команду експертів.",
};
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          <div className="space-y-8">
            <h1 className="font-headline-xl text-4xl md:text-5xl lg:text-6xl text-white">
              VOLT <span className="text-primary-fixed">PREMIUM</span>
            </h1>
