...
export default function RootLayout({
  ...
  return (
    <html lang="uk" className="dark">
      ...
      <body className="bg-background text-on-background font-body-md selection:bg-primary-fixed selection:text-on-primary-fixed overflow-x-hidden max-w-[1920px] mx-auto">
        <Providers>
          <Header />
          {children}
          <Footer />
