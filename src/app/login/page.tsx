    ...
    <main className="min-h-screen bg-background text-on-background font-body-md flex items-center justify-center px-margin-mobile md:px-margin-desktop py-20 relative overflow-hidden">
      ...
      >
        <div className="text-center mb-10">
          ...
          <h1 className="font-headline-xl text-white mb-2">Вхід у кабінет</h1>
          <p className="text-secondary-fixed-dim font-body-md">Керування вашим енерго-майбутнім</p>
        </div>
        ...
        <form className="space-y-5" onSubmit={handleSubmit}>
          ...
          <button disabled={loading} className="w-full bg-primary-fixed text-on-primary-fixed py-5 rounded-lg font-bold text-lg hover:shadow-[0_0_15px_rgba(213,240,0,0.3)] transition-all flex items-center justify-center gap-2 mt-4">
          ...
          <p className="text-center text-secondary-fixed-dim text-sm mt-6">
            Немає акаунту? <Link href="/register" className="text-primary-fixed hover:underline">Зареєструватися</Link>
          </p>
        </form>
      </motion.div>
    </main>
